                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item position-relative {{$key==0 ? 'active' : ''}}" style="height: 430px;">
                            ...
                            src="{{$slide->image ? ''.Storage::url($slide->image) : 'https://picsum.photos/seed/picsum/1393/430'}}" 
                ...
                <a class="text-decoration-none" href="">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="{{$brand->image ? ''.Storage::url($brand->image) : 'https://picsum.photos/seed/picsum/100/100'}}" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>{{$brand->brand_name}}</h6>
                            <small class="text-body">{{$brand->countProduct}} sản phẩm</small>
                        </div>
                    </div>
                </a>
            </div>
