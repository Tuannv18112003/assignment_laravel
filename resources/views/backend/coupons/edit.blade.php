            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('coupon.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Tên mã </label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Mã code</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="code_discount" value="{{$coupon->code_discount}}">
                                @error('code_discount')
                                    <span style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Giảm giá(%)</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="discount" value="{{$coupon->discount}}">
                                @error('discount')
                                    <span style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img class="rounded avatar-lg" id="show_image"
                                    src="{{$coupon->image ? Storage::url($coupon->image) : ''}}"
                                    alt="Card image cap">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            <label for="" class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <button class="btn btn-primary waves-effect waves-light">Thêm mã</button>
                            </div>
                        </div>
                    </form>
                </div>
