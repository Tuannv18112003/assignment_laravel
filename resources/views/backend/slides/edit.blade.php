...
@section('admin')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Chỉnh sửa slides</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Chỉnh sửa slides</h4>
                    <form action="{{ route('slide.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="" class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <button class="btn btn-primary waves-effect waves-light">Chỉnh sửa slide</button>
                            </div>
                        </div>
                    </form>
                </div>
